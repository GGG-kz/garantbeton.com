...
import { Plus, User, Phone, Key, UserCheck, Edit, Trash2, Truck } from 'lucide-react'
...
export default function DriversPage() {
  ...
  const filteredDrivers = drivers.filter(driver => 
    ...
    driver.login.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 pl-10 border border-mono-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-sm border border-mono-200 p-6">
          <div className="flex items-center">
            <Truck className="h-8 w-8 text-mono-600" />
            <div className="ml-4">
      ...
      {filteredDrivers.length === 0 && searchQuery && (
        <div className="text-center py-12">
          <User className="h-16 w-16 mx-auto mb-4 text-mono-300" />
